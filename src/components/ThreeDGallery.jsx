...
const images = [
  // Back
  { position: [-0.8, 0, -0.6], rotation: [0, 0, 0], url: "/test.jpeg" },
  { position: [0.8, 0, -0.6], rotation: [0, 0, 0], url: "/test2.jpeg" },
  // Left
...
export default function ThreeDGallery () {
  return(
    <Canvas dpr={[1, 1.5]} camera={{ fov: 70, position: [0, 2, 15] }}>
      ...
      <fog attach="fog" args={['#363636', 0, 15]} />
  ...
  return (
    <group {...props}>
      <mesh
        ...
        <boxGeometry />
        <meshStandardMaterial color="#00947e" metalness={0.5} roughness={0.5} envMapIntensity={2} />
